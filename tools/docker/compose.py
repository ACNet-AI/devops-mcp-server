...
def docker_compose_up(
    ...
    try:
        ...
        return {
            ...
            "message": "Services started successfully" if result.returncode == 0 else "Failed to start services"
        }
...
def docker_compose_down(
    ...
    try:
        ...
        return {
            ...
            "stdout": result.stdout,
            "stderr": result.stderr,
            "message": "Services stopped successfully" if result.returncode == 0 else "Failed to stop services"
        }
    except subprocess.TimeoutExpired:
        return {
            "success": False,
...
def docker_compose_restart(
    ...
    try:
        ...
        return {
            ...
            "stdout": result.stdout,
            "stderr": result.stderr,
            "message": f"{'Service' if service else 'Services'} restarted successfully" if result.returncode == 0 else "Failed to restart"
        }
    except subprocess.TimeoutExpired:
        return {
            "success": False,
